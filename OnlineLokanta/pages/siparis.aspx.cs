...

{
    ...
    public partial class siparis : System.Web.UI.Page {
        ...
        protected void yerat_Click(object sender, EventArgs e)
        {
            ...
            if(i==1)
            {
                Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "Başlık", "<script>alert('Yeriniz Başarı ile Ayrılmıştır...');</script>");
            }
            else
                Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "Başlık", "<script>alert('Yeriniz Ayrılamamıştır...');</script>");
        ...
        protected void ymkbtn_Click(object sender, EventArgs e)
        {
